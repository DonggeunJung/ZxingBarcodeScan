...
import com.example.zxingbarcodescan.*;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderColor = Color.argb(255, 204, 250, 68);
    ...
    private final int mDefaultLaserColor = Color.argb(255, 204, 0, 0);
    private final int mDefaultMaskColor = Color.argb(96, 0, 0, 0);
    //private final int mDefaultBorderColor = Color.argb(255, 175, 237, 68);
    //private final int mDefaultBorderStrokeWidth = 5;
    //private final int mDefaultBorderLineLength = 80;
